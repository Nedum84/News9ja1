...
class ActivityListNewsCategory : AppCompatActivity() {
    ...
    private fun loadNewsData(){
        ...
        val currentCategoryId = ClassSharedPreferences(this).getCurrentCategoryId()
        toolbar?.title = newsListDBHelper.readCategoryDetails(currentCategoryId)[0][1]
